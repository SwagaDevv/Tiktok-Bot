...
class Zefoy:
  ...
  / _` \ \ /\ / / '_ \| | | |  | | |  | | |     
 | (_| |\ V  V /| |_) | | | |__| | |__| | |____ 
  \__,_| \_/\_/ |_.__/|_|  \____/ \____/|______|
...
"""   
    ...
    def task(self) -> None:
        ...
        while True:
            ...
            if 'sent' in source:
                self.sent += 1
                self.title(f'Tiktok Bot By Swaga ~ Using Selenium ▏  Sent: {self.sent} ▏  Cooldown: 0')
                break
    ...
    def main(self) -> None:
        self.clear()
        print(self.display_banner())
        self.title('Tiktok Bot By Swaga ~ Using Selenium ▏  Status: Loading')
        ...
        self.title('Tiktok Bot By Swaga ~ Using Selenium ▏  Status: Solving')
        self._print('*', 'Solving The Captcha')
        self.solve()
        
        self.clear()
        self.title('Tiktok Bot By Swaga ~ Using Selenium ▏  Status: N/A')
